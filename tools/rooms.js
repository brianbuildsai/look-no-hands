...
<div class="controls" role="group" aria-label="Docent controls">
  ...
  <div class="controls__row">
    ...
    },
    {
      ...
      slug: 'undercroft',
      ready: true,
      scripts: ['game/pixels.js', 'game/classes.js', 'game/weapons.js', 'game/arms.js', 'game/world.js', 'game/explore.js', 'game/actors.js', 'game/relics.js', 'game/guardians.js', 'game/boss-golem.js', 'game/boss-wyrm.js', 'game/boss-thornmother.js', 'game/boss-herald.js', 'game/boss-orrery.js', 'game/boss-lightless.js', 'game/samples.js', 'game/sound.js'],
      ...
      description: 'A rogue-like platformer, the last room: four characters to choose from, stages of chambers to explore for a hidden portal, a sanctuary with three perks between each, ten creatures, thirteen weapons and twenty-eight items in four rarities that say exactly what they do, five floors each with a guardian and a hall of its own, and a last one under them. Pixel art compiled from text; music synthesised; sound effects recorded, the one thing in the building that is loaded, and only if you ask for sound.',
